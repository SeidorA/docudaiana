...
Esta guía ofrece una visión completa de la arquitectura de Sequential Agent AI dentro de Daiana Studio, explorando sus componentes principales y principios de diseño del flujo de trabajo.

::::warning
Esta documentación está destinada a ayudar a los usuarios de Daiana Studio a entender y construir flujos de trabajo conversacionales usando la arquitectura Sequential Agent. No pretende ser una referencia técnica exhaustiva del framework LangGraph y no debe interpretarse como una definición de estándares de la industria o conceptos fundamentales de LangGraph.
::::

## Concepto

Construido sobre **LangGraph**, la arquitectura Sequential Agents de Daiana Studio facilita el **desarrollo de sistemas agénticos conversacionales estructurando el flujo de trabajo como un grafo cíclico dirigido (DCG)**, permitiendo bucles controlados y procesos iterativos.
...
<Tabs>
<TabItem value="Principios_Fundamentales" label="Principios Fundamentales" default>
...
<TabItem value="Terminología" label="Terminología">
...
Si bien tanto los sistemas Multi-Agent como Sequential Agent en Daiana Studioestán construidos sobre el framework LangGraph y comparten los mismos principios fundamentales, la arquitectura Sequential Agent proporciona un nivel más bajo de abstracción(En nuestro contexto actual, un nivel más bajo de abstracción se refiere a un sistema que expone un mayor grado de detalle de implementación al desarrollador), ofreciendo un control más granular sobre cada paso del flujo de trabajo.
...
Los Sequential Agents de Daiana Studioofrecen nuevas capacidades para crear sistemas conversacionales que pueden adaptarse a la entrada del usuario, tomar decisiones basadas en el contexto y realizar tareas iterativas.
...
<p alibg="center">
![Supervizor](/img/studio/agentflow/secuence/loop.png)
</p>
...
Aquí hay una tabla comparando las implementaciones Multi-Agent y Sequential Agent en Daiana Studio, destacando diferencias clave y consideraciones de diseño:
...
Los Sequential Agents introducen una nueva dimensión a Daiana Studio, **introduciendo 10 nodos especializados**, cada uno sirviendo un propósito específico, ofreciendo más control sobre cómo nuestros agentes conversacionales interactúan con los usuarios, procesan información, toman decisiones y ejecutan acciones.
...
<p alibg="center">
![Supervizor](/img/studio/agentflow/secuence/image.webp)
</p>
...
<p align="center">
![Supervizor](/img/studio/agentflow/secuence/start.png)
</p>
...
<Tabs>
  <TabItem value="Pro Tips" label="Pro Tips" default>
...
Si tu caso de uso lo demanda, utiliza Agent Memory Node para mantener el contexto y personalizar interacciones.
  ...
  <TabItem value="Posibles dificultades" label="Posibles dificultades">
...
<p align="center">
![Supervizor](/img/studio/agentflow/secuence/memory.png)
</p>
...
Por defecto, Daiana Studioutiliza su **base de datos SQLite integrada** para almacenar el historial de conversación y datos de state personalizados, creando una tabla "**checkpoints**" para gestionar esta información persistente.
...
<p align="center">
![Supervizor](/img/studio/agentflow/secuence/checkpoints.png)
</p>
...
<p align="center">
![Supervizor](/img/studio/agentflow/secuence/statenode.png)
</p>
...
### Cómo establecer un State personalizado 
...
<p align="center">
![Supervizor](/img/studio/agentflow/secuence/ejtabla.png)
</p>
...
<p align="center">
![Supervizor](/img/studio/agentflow/secuence/agentnode.png)
</p>
...
<p align="center">
![Supervizor](/img/studio/agentflow/secuence/llmode.png)
</p>
...
<p align="center">
![Supervizor](/img/studio/agentflow/secuence/tool.png)
</p>
...
<p align="center">
![Supervizor](/img/studio/agentflow/secuence/conditional.png)
</p>
...
<p align="center">
![Supervizor](/img/studio/agentflow/secuence/conditionalll.png)
</p>
...
<p align="center">
![Supervizor](/img/studio/agentflow/secuence/loopnode.png)
</p>
...
<TabItem value="Posibles dificultades" label="Orange">
...
Los nodos Condition y Condition Agent son esenciales en la arquitectura Sequential Agent de Daiana Studiopara crear experiencias conversacionales dinámicas.
