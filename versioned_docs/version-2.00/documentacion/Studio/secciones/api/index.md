...
<Feature title="Archivos adjuntos" description="Return contents of the files in plain string format" icon="network" link="/docs/api/attachments" />
<Feature title="Mensaje de chat" description="Referencia de API para crear y administrar asistentes virtuales" link="/docs/api/chatmessage" icon="network" />
...
<Feature title="Prospectos" description="Referencia de API para capturar y gestionar prospectos generados desde los flujos" link="/docs/api/leads" icon="network" />
