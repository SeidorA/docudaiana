...
![a](/img/agentes/crear/fuentes.jpg)
...
3. Confirme la selección.
  ...
  <TabItem value="Sharepoint" label="Sharepoint">
...
1. Creación de la aplicación en Azure  
...
3. Obtención identificador de carpeta ShareFolder 
...
5. Conexión de carpeta a asistente de SharePoint :  
...
![4.png](/img/screenshots/sharepoint/paso4/endsharepoint.png)
...
<TabItem value="One Drive" label="One Drive">
...
2. Registro de la Aplicación
  ...
  - En el menú de navegación izquierdo, selecciona  **Microsoft Entra ID**.
  ![p1.png](/img/integraciones/onedrive/p2.png)
  ![p1.png](/img/integraciones/onedrive/p3.png)

  - Haz clic en Registros de **aplicaciones > Nuevo registro.**
...
- Ve a la página de la aplicación registrada.
![p1.png](/img/integraciones/onedrive/p7.png)

- En el menú lateral, selecciona **Permisos de la API.**
...
- Busca y selecciona los permisos necesarios, por ejemplo:
...
- Si los permisos requieren consentimiento del administrador, haz clic en **Conceder consentimiento de administrador para [tu inquilino]**.
![p1.png](/img/integraciones/onedrive/p14.png)

- Confirma la acción.

- Cuando el administrador haya dado de alta los permisos se vera algo así:
![p1.png](/img/integraciones/onedrive/p15.png)

5. Configurar un Secreto de Cliente (Client Secret)

- En la configuración de la aplicación, selecciona Certificados y secretos.
![p1.png](/img/integraciones/onedrive/p16.png)

- Haz clic en Nuevo secreto de cliente.
![p1.png](/img/integraciones/onedrive/p17.png)

- Asigna una descripción y establece la duración del secreto.

![p8.png](/img/integraciones/onedrive/p18.png)
- Haz clic en Agregar.
- Copia el Valor del Secreto y guárdalo de manera segura.
...
![1.png](/img/screenshots/sharepoint/paso4/end.png)
